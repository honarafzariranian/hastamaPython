(() => {
    ...
    function renderConversation(data) {
        ...
        }).join('') || '<div class="internal-automation-list-empty">هنوز پیامی ثبت نشده است.</div>'}</div>${completed ? '<div class="internal-automation-completed-note">این گفتگو به پایان رسیده و برای ارسال پیام باید دوباره فعال شود.</div>' : '<form class="internal-automation-composer"><textarea name="body" maxlength="4000" required placeholder="پیام خود را بنویسید…"></textarea><div><label class="internal-automation-file-picker"><span class="internal-automation-file-icon" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><path d="m16.5 6.5-7.8 7.8a3.2 3.2 0 0 0 4.5 4.5l7-7a4.7 4.7 0 0 0-6.7-6.7l-7.4 7.4a6.2 6.2 0 0 0 8.8 8.8l6.1-6.1"></path></svg></span><span>فایل</span><input type="file" name="file" accept=".pdf,.png,.jpg,.jpeg,.webp,.txt,.doc,.docx,.xls,.xlsx"></label><button type="submit">ارسال پیام</button><span class="internal-automation-status"></span></div></form>'}`;
